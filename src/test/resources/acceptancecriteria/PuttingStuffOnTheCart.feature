...
Feature: Putting any stuff on the cart while a user has money. 
	As a user, I want to choose any items on Netshoes website to spend his money.

Scenario Outline: Choosing items to put on the Cart while I have money 
