...
public class HomePage {
	...
	private static final By _buttonMainFilterLocator = xpath(
			"//button[contains(@class,'border ns-icon ns-icon-search')]");
	private static final By _clickOnLoginButtonLocator = xpath(
			"//*[@class='ns-icon ns-icon-arrow-down prv-action ns-void-link']//i[@class='ns-icon-user-ico']");
	...
	private static final By _myWishListButtonLocator = xpath(
			"//*[@class='my-wishlist']//a[contains(@href,'wishlist')]");
	...
	private static final By _redirectToSocialMediaLocator = xpath(
			"//ul[@class='share-bar-social']//a[contains(@class, 'youtube')]");
